...
public:
	...
	CMouseEvent(EMouseEventType _event)
	{
		InputType = EIT_MOUSE;
		Event = _event;
	}
...
class CTouchEvent: public CInputEvent
{
public:
...
class CGestureEvent: public CInputEvent
{
public:
	enum EGestureType
	{
